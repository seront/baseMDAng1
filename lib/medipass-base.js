...
var TableController = function () {
  function TableController($filter, $mdMedia, $scope, $window) {
    'ngInject';
    ...
    this.$scope.$watch(function () {
      return _this.$mdMedia('print');
    }, function (print) {
      if (print === true && _this._actions.length === 0) {
        _this.beforePrint();
      } else if (print === false && _this._actions.length > 0 && _this.actions.length === 0) {
        _this.afterPrint();
      }
    });
  }
