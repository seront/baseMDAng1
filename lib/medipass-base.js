...
})(this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_22__, __WEBPACK_EXTERNAL_MODULE_25__) {
...
exports.CommonsModule = exports.ComponentsModule = undefined;
...
var _angularTranslate = __webpack_require__(22);
...
var _medipassTheme = __webpack_require__(23);
...
exports.default = _angular2.default.module('medipass.base', [_angularMaterial2.default, _angularTranslate2.default, _components2.default, _table2.default, _common2.default]).config(_medipassTranslate.translateConfig).config(_medipassTheme2.default).name;
...
var _access = __webpack_require__(4);
...
var _access = __webpack_require__(6);

var _accessLogin = __webpack_require__(8);

var _accessRecuperarModule = __webpack_require__(10);

var _accessRecuperarModule2 = _interopRequireDefault(_accessRecuperarModule);

var _access2 = __webpack_require__(13);

var _access3 = _interopRequireDefault(_access2);

var _access4 = __webpack_require__(14);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _angular2.default.module('medipass.access', [_angularMaterial2.default, _url2.default,
// AccessLoginModule,
_accessRecuperarModule2.default]).component('access', _access.AccessComponent).component('accessLogin', _accessLogin.AccessLogin).service('AccessService', _access4.AccessService).config(_access3.default).name;
...
var UrlModule = exports.UrlModule = angular.module('medipass.url', []).service("UrlService", UrlService).name;
...
var AccessLoginController = function () {
  function AccessLoginController($log, AccessService) {
...
var _accessRecuperarComponent = __webpack_require__(11);
...
var AccessRecuperarController = function () {
  ...
  _createClass(AccessRecuperarController, [{
    ...
    value: function resetPwd() {
      this.AccessService.resetPwd(this.username, this.email).then(function (respose) {});
    }
  }]);
...
var AccessService = exports.AccessService = function () {
  function AccessService($log, $http, UrlService) {
  ...
  _createClass(AccessService, [{
    ...
    value: function login(username, pwd) {
      ...
      return this.$http.get(this.UrlService.login, { username: username, password: pwd }).then(function (response) {
    ...
    value: function resetPwd(username, email) {
      ...
      return this.$http.get(this.UrlService.resetPwd, { username: username, email: email }).then(function (response) {
        return response.data;
      });
    }
  }]);
...
var _angularMaterialDataTable = __webpack_require__(25);
