...
exports.default = _angular2.default.module('medipass.base', ['ngMaterial', 'translate', 'ComponentsModule', 'CustomTableModule', 'FinanciadorModule', 'PrestadorModule', 'CommonsModule']).config(_medipassTranslate.translateConfig).config(_medipassTheme2.default).name;
