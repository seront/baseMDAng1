...
// AccessLoginModule,
_accessRecuperarModule2.default]).component('access', _access.AccessComponent).component('accessLogin', _accessLogin.AccessLogin).factory('AccessService', _access4.AccessService).config(_access3.default).config(['$httpProvider', function ($httpProvider) {
